  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((res) => {
        ...
        fetch(`https://scholarship-server-beta.vercel.app/add-application`, {
          method: "POST",
      ...
      .catch((err) => {
        toast.error(
          "An error occurred while uploading you image. Please try again!"
        );
      });
  };
      ...
      <section className="bg-[#f1f2f8] py-20">
        <div className="bg-white max-w-max mx-auto border-2 shadow-xl rounded-lg overflow-hidden  p-10 px-16 gap-10 flex">
          <div className=" text-center flex flex-col max-w-36  items-center">
            ...
            />{" "}
            <h2 className="font-bold text-xl text-[#0c281b] mb-6">
              {universityName}
            </h2>
          </div>
          ...
          <div className="">
            <div className="space-y-2">
              <h2 className="font-bold text-3xl text-[#0c281b]">
                {scholarshipName}
              </h2>
              ...
              <div className="flex justify-between flex-col md:flex-row">
                <div className="space-y-1">
                  <h2 className="text-xl pb-2 pt-3 font-bold">
                  ...
                  <p className="flex items-center gap-2">
                    <MdOutlineAccessTime /> {applicationDeadline}
                  </p>
                  <p className="flex items-center gap-2">
                    <BsCashCoin />
                    {tuitionFees}
                    <small className="-mt-2 -ml-1">{"*Tuition fee"}</small>
                  </p>
                </div>
                <div className="space-y-1">
                  <h2 className="text-xl pb-2 pt-3 font-bold">
                  ...
                  <p className="flex items-center gap-2">
                    <AiOutlineDollar />
                    {applicationFees + " + " + serviceCharge}
                    <small className="-mt-2 -ml-1">*service charge</small>
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="modal" role="dialog">
        <div className="modal-box">
          <h2 className="text-xl font-semibold mb-5">
            Amount needs to pay:{" "}
            {parseInt(serviceCharge) + parseInt(applicationFees)}
          </h2>
          <Elements stripe={stripePromise}>
            <PaymentForm
              setPaymentSuccess={setPaymentSuccess}
              price={parseInt(serviceCharge) + parseInt(applicationFees)}
            />
          </Elements>
        </div>
      </div>
