...
const ManageApplications = () => {
  ...
  useEffect(() => {
    fetch(
      `https://scholarship-server-beta.vercel.app/all-application?email=${user?.email}`
    )
      .then((res) => res.json())
  ...
  const handleFeedback = (e, id) => {
    e.preventDefault();
    fetch(
      `https://scholarship-server-beta.vercel.app/update-feedback/${id}?email=${user?.email}`,
      {
        method: "PATCH",
        headers: {
  ...
  const handleReject = (id, item) => {
    ...
    fetch(
      ...
      .catch((err) =>
        toast.error("Something bad happened! Rejection unsuccessful")
      );
  };
    ...
    <section className="bg-[#f1f2f8] h-full py-14">
      ...
      <div className="overflow-x-auto">
        ...
        <div className="modal" role="dialog">
          <form
            onSubmit={(e) => handleFeedback(e, modalData._id)}
            className="modal-box"
          >
            <h2 className="text-center py-5 mb-7 font-bold text-2xl">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="col-span-1 flex flex-col gap-5">
                ...
                <label className="form-control text-start w-full max-w-xs">
                  ...
                  <input
                    value={modalData?.scholarshipName}
