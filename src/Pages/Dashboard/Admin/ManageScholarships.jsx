...
const ManageScholarships = () => {
  ...
  const handleDelete = (id) => {
    fetch(
      `https://scholarship-server-beta.vercel.app/delete-scholarship/${id}?email=${user?.email}`,
      {
        method: "DELETE",
      }
    )
  ...
  const handleUpdate = (e, id, idx) => {
    ...
    const month = new Date(new Date()).toLocaleDateString("default", {
      month: "long",
    });
    ...
    fetch(
      ...
      .then((res) => {
        fetch(
          `https://scholarship-server-beta.vercel.app/update-scholarship/${id}?email=${user?.email}`,
          {
            method: "PATCH",
            headers: {
                      ...
                      <div className="flex gap-5 justify-center">
                        <div className="flex flex-col gap-5">
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <input
                              ...
                              type="file"
                              placeholder="Type here"
                              className="input py-2 input-bordered w-[300px]"
                            />
                          </label>
                          <label className="form-control w-[300px]">
                            <div className="label">
                            ...
                            <input
                              defaultValue={item.universityCountry}
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <input
                              defaultValue={item.universityCity}
                              name="universityCity"
                              required
                              type="text"
                              placeholder="Type here"
                        ...
                        <div className="flex flex-col gap-5">
                          <label className="form-control w-[300px]">
                            ...
                            <select
                              defaultValue={item.subjectCategory}
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <select
                              defaultValue={item.scholarshipCategory}
                              className="input input-bordered"
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <input
                              defaultValue={item.applicationFees}
                        ...
                        <div className="flex flex-col gap-5">
                          <label className="form-control w-[300px]">
                            ...
                            <input
                              ...
                              type="number"
                              placeholder="Type here"
                              className="input flex items-center input-bordered w-[300px]"
                            />
                          </label>
                          <label className="form-control w-[300px]">
                            <div className="label">
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <input
                              defaultValue={item.universityWorldRank}
                          ...
                          <label className="form-control w-[300px]">
                            ...
                            <textarea
                              ...
                              name="description"
                              className="input p-2 input-bordered w-[300px] h-40"
                              id=""
                            ></textarea>
                          </label>
                        </div>
